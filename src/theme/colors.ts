...
export const ACCENT_DARK = '#6E8C5C';   // deep olive — accessible text on light
export const FG          = '#1A1A1A';   // near-black foreground
...
// Semantic aliases
export const SUCCESS     = '#5A7A4A';
export const WARNING     = '#C45D3E';
