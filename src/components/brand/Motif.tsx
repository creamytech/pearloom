...
// ─────────────────────────────────────────────────────────────
// Pearloom / brand/Motif.tsx
//
// Motif — the Pearloom line-ornament set. Single-stroke editorial
// glyphs (1.75px round caps, fill:none) that scatter through a
// site: section openers, list bullets, empty-state centerpieces,
// sticker decor, the wizard's occasion tiles + live preview, and
// the editor's theme-settings ornament picker. One consistent
// hand across every occasion.
//
