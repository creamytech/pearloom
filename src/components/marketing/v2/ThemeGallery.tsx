...
export const THEME_PACKS: ThemePack[] = [
  {
    ...
    palette: ['#5C6B3F', '#C8B3D9', '#E8DFE9', '#F4ECD8', '#B8935A'],
  ...
  },
  {
    ...
    palette: ['#E8C77A', '#D9A89E', '#C47A4A', '#F1E6C8', '#B8935A'],
  ...
  },
  {
    ...
    palette: ['#1F2418', '#C8BFA5', '#F4ECD8', '#6B7A3A', '#B8935A'],
    displayFont: 'Canela',
    bodyFont: 'Inter',
  ...
  },
  {
    ...
    palette: ['#E3DCC0', '#D9A89E', '#6B7A3A', '#F7F0DC', '#B8935A'],
