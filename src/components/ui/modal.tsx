  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-white/90 backdrop-blur-2xl backdrop-saturate-150 rounded-[var(--pl-radius-xl)] p-8',
        'border border-[rgba(255,255,255,0.6)]',
        'shadow-[0_16px_48px_rgba(43,30,20,0.1),0_32px_80px_rgba(43,30,20,0.06),inset_0_1px_0_rgba(255,255,255,0.5)]',
