...
export function SiteGallerySection({ siteId, coupleNames }: SiteGalleryProps) {
  ...
  const minimalVibeSkin: VibeSkin = { tone: 'dreamy', decorIcons: ['✦'], accentSymbol: '♡', particleColor: '#5C6B3F', dividerQuote: '', sectionLabels: { story: '', events: '', registry: '', travel: '', faqs: '', rsvp: '', photos: '' }, aiGenerated: false, curve: 'wave', particle: 'petals', accentShape: 'ring', sectionEntrance: 'fade-up', texture: 'none', cornerStyle: '1rem', wavePath: '', wavePathInverted: '', palette: { background: '#F5F1E8', foreground: 'var(--pl-ink-soft)', accent: '#5C6B3F', accent2: '#D6C6A8', card: 'var(--pl-ink-soft)', muted: '#9A9488', highlight: '#7D9B6A', subtle: '#F9F6EF', ink: '#1C1C1C' }, fonts: { heading: 'Playfair Display', body: 'Inter' }, headingStyle: 'italic-serif', cardStyle: 'elevated', sectionGradient: 'linear-gradient(135deg, #F9F6EF 0%, var(--pl-ink-soft) 100%)' };
  return (
    <>
      <RsvpLiveCounter siteId={siteId} coupleNames={coupleNames} />
      <section style={{ padding: '6rem 2rem', background: 'var(--pl-cream)' }}>
