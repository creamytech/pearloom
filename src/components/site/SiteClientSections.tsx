...
export function SiteGallerySection({ siteId, coupleNames }: SiteGalleryProps) {
  ...
  const minimalVibeSkin: VibeSkin = { tone: 'dreamy', decorIcons: ['✦'], accentSymbol: '♡', particleColor: '#A3B18A', dividerQuote: '', sectionLabels: { story: '', events: '', registry: '', travel: '', faqs: '', rsvp: '', photos: '' }, aiGenerated: false, curve: 'wave', particle: 'petals', accentShape: 'ring', sectionEntrance: 'fade-up', texture: 'none', cornerStyle: '1rem', wavePath: '', wavePathInverted: '', palette: { background: '#F5F1E8', foreground: '#2B2B2B', accent: '#A3B18A', accent2: '#D6C6A8', card: 'rgba(255,255,255,0.55)', muted: '#9A9488', highlight: '#7D9B6A', subtle: '#F9F6EF', ink: '#1C1C1C' }, fonts: { heading: 'Playfair Display', body: 'Inter' }, headingStyle: 'italic-serif', cardStyle: 'elevated', sectionGradient: 'linear-gradient(135deg, #F9F6EF 0%, rgba(255,255,255,0.55) 100%)' };
  return (
    <>
