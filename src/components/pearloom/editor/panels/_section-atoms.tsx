...
/* No useSectionHidden hook / per-panel visibility footer here
   (EDITOR-CALM-PLAN E.2): the rail row's eye button + options
   popover (PropertyRail) are the ONE home for hide/show — the
   per-panel footer was a third copy, mounted 28 times. PropertyRail
   keeps its own local useSectionHidden over the same
   manifest.hiddenSections array. */
