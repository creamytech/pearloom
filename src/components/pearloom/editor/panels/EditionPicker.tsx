...
function PreviewAlmanac() {
  return (
    <svg viewBox="0 0 240 100" width="100%" height="100%" preserveAspectRatio="none">
      ...
      <line x1="58" y1="20" x2="218" y2="20" stroke="#C19A4B" strokeWidth="0.5" />
...
function PreviewCinema() {
  return (
    <svg viewBox="0 0 240 100" width="100%" height="100%" preserveAspectRatio="none">
      ...
      <rect x="6" y="6" width="6" height="6" fill="#C19A4B" opacity="0.5" />
      <rect x="228" y="88" width="6" height="6" fill="#C19A4B" opacity="0.5" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 240 100" width="100%" height="100%" preserveAspectRatio="none">
      ...
      <g transform="rotate(-4 60 50)">
        <rect x="14" y="20" width="80" height="60" fill="#FBF7EE" stroke="#C19A4B" strokeOpacity="0.3" />
        <rect x="22" y="28" width="64" height="36" fill="#C49A6F" opacity="0.6" />
      </g>
      <g transform="rotate(3 170 50)">
        <rect x="120" y="18" width="100" height="64" fill="#FBF7EE" stroke="#C19A4B" strokeOpacity="0.3" />
...
function PreviewLinen() {
  return (
    <svg viewBox="0 0 240 100" width="100%" height="100%" preserveAspectRatio="none">
      ...
      <line x1="110" y1="32" x2="220" y2="32" stroke="#C19A4B" strokeWidth="0.6" />
      ...
      <line x1="110" y1="68" x2="220" y2="68" stroke="#C19A4B" strokeWidth="0.6" />
      <circle cx="100" cy="92" r="1.5" fill="#C19A4B" />
