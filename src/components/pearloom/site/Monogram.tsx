...
/* ── Initial extraction. Mirrors the prototype's logic:
   ...
   The implementation lives in the server-safe `@/lib/monogram` so
   server code (suite/theme.ts, the guest passport page) can call it
   without React's "client function from the server" guard firing.
   Re-exported here for the many client consumers that already
   import it from this component. */
