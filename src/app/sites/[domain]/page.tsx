...
export default async function SubdomainSite({
  ...
  // The staged-editing model (C.2): guests see the published
  // SNAPSHOT when one exists; the working copy the editor autosaves
  // into stays private until the host presses "Update site". No
  // snapshot = editing-live, the original behavior.
