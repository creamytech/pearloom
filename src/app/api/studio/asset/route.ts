...
const PROMPT_BY_KIND: Record<AssetKind, (paletteHint: string, occasionHint: string) => string> = {
  ...
  leaf: (palette, occ) => `A delicate botanical line illustration of olive or eucalyptus sprigs, ink + sage greens, on transparent background. Editorial stationery feel for a ${occ}. Centred composition, hand-drawn lineweight, no shading blocks. Output PNG transparent 1024×1024.`,
