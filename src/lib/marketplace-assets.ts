...
const minimalistIcons: AssetPack = {
  ...
  category: 'icons',
  items: [
    asset('minimalist-icons/heart-line', 'Heart Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M24 40L8 24a8 8 0 0 1 0-11.3 8 8 0 0 1 11.3 0L24 17.4l4.7-4.7a8 8 0 0 1 11.3 0 8 8 0 0 1 0 11.3L24 40z"/></svg>'),
    asset('minimalist-icons/ring-simple', 'Ring Simple', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="26" r="14"/><path d="M18 12l6-6 6 6"/></svg>'),
    asset('minimalist-icons/glass-toast', 'Glass Toast', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M14 6l-2 18h12l-2-18z"/><line x1="18" y1="24" x2="18" y2="36"/><line x1="12" y1="36" x2="24" y2="36"/><path d="M30 6l2 18H20l2-18z" transform="translate(16 0)"/></svg>'),
    asset('minimalist-icons/map-pin', 'Map Pin', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M24 44s-14-12-14-22a14 14 0 0 1 28 0c0 10-14 22-14 22z"/><circle cx="24" cy="22" r="5"/></svg>'),
    asset('minimalist-icons/calendar-line', 'Calendar Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="10" width="36" height="32" rx="3"/><line x1="6" y1="20" x2="42" y2="20"/><line x1="16" y1="6" x2="16" y2="14"/><line x1="32" y1="6" x2="32" y2="14"/></svg>'),
    asset('minimalist-icons/gift-box', 'Gift Box', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="18" width="36" height="24" rx="2"/><rect x="4" y="12" width="40" height="8" rx="2"/><line x1="24" y1="12" x2="24" y2="42"/><path d="M24 12c-4-8-14-6-10 0M24 12c4-8 14-6 10 0"/></svg>'),
    asset('minimalist-icons/plane-simple', 'Plane Simple', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M24 4l-4 16-14 4 14 4 4 16 4-16 14-4-14-4z"/></svg>'),
    asset('minimalist-icons/camera-line', 'Camera Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="14" width="40" height="28" rx="3"/><circle cx="24" cy="28" r="8"/><path d="M16 14l2-6h12l2 6"/></svg>'),
    asset('minimalist-icons/music-note', 'Music Note', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="8" x2="20" y2="36"/><ellipse cx="14" cy="36" rx="6" ry="5"/><path d="M20 8l16-4v8l-16 4z"/></svg>'),
    asset('minimalist-icons/envelope-line', 'Envelope Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="10" width="40" height="28" rx="2"/><path d="M4 10l20 16L44 10"/></svg>'),
    asset('minimalist-icons/star-simple', 'Star Simple', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><polygon points="24,4 29,18 44,18 32,28 36,42 24,34 12,42 16,28 4,18 19,18"/></svg>'),
    asset('minimalist-icons/clock-line', 'Clock Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="20"/><line x1="24" y1="24" x2="24" y2="12"/><line x1="24" y1="24" x2="34" y2="28"/></svg>'),
    asset('minimalist-icons/home-line', 'Home Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M6 24L24 6l18 18"/><path d="M10 24v18h10V32h8v10h10V24"/></svg>'),
    asset('minimalist-icons/key-line', 'Key Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="18" r="8"/><line x1="20" y1="22" x2="42" y2="42"/><line x1="36" y1="36" x2="42" y2="30"/><line x1="30" y1="30" x2="36" y2="24"/></svg>'),
    asset('minimalist-icons/compass-line', 'Compass Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="20"/><polygon points="20,28 18,18 28,20 30,30"/></svg>'),
    asset('minimalist-icons/feather-line', 'Feather Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M6 42L18 30M38 6c0 12-8 24-20 30l8-12-6-2 10-10-6-2z"/></svg>'),
    asset('minimalist-icons/flower-line', 'Flower Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="20" r="4"/><circle cx="24" cy="10" r="6"/><circle cx="24" cy="30" r="6"/><circle cx="14" cy="20" r="6"/><circle cx="34" cy="20" r="6"/><line x1="24" y1="28" x2="24" y2="44"/></svg>'),
    asset('minimalist-icons/sun-line', 'Sun Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="8"/><line x1="24" y1="4" x2="24" y2="12"/><line x1="24" y1="36" x2="24" y2="44"/><line x1="4" y1="24" x2="12" y2="24"/><line x1="36" y1="24" x2="44" y2="24"/><line x1="10" y1="10" x2="16" y2="16"/><line x1="32" y1="32" x2="38" y2="38"/><line x1="38" y1="10" x2="32" y2="16"/><line x1="16" y1="32" x2="10" y2="38"/></svg>'),
    asset('minimalist-icons/moon-line', 'Moon Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M36 24a16 16 0 1 1-16-16 12 12 0 0 0 16 16z"/></svg>'),
    asset('minimalist-icons/sparkle-line', 'Sparkle Line', 'svg', 'icons', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M24 4l3 14 14 3-14 3-3 14-3-14-14-3 14-3z"/><path d="M38 6l1 5 5 1-5 1-1 5-1-5-5-1 5-1z"/></svg>'),
  ],
};
...
const watercolorWashes: AssetPack = {
  ...
  items: [
    asset('watercolor-washes/blush-wash', 'Blush Wash', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#f8e8e8"/><ellipse cx="20" cy="20" rx="18" ry="14" fill="#f0c4c4" opacity="0.6"/><ellipse cx="30" cy="30" rx="16" ry="12" fill="#e8a0a0" opacity="0.4"/></svg>'),
    asset('watercolor-washes/sage-wash', 'Sage Wash', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#e8ede8"/><ellipse cx="24" cy="22" rx="20" ry="14" fill="#b8ccb0" opacity="0.5"/><ellipse cx="28" cy="32" rx="16" ry="10" fill="#98b490" opacity="0.4"/></svg>'),
    asset('watercolor-washes/sunset-wash', 'Sunset Wash', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#fce8d8"/><ellipse cx="18" cy="24" rx="18" ry="16" fill="#f0b888" opacity="0.5"/><ellipse cx="32" cy="28" rx="14" ry="12" fill="#e88860" opacity="0.4"/></svg>'),
    asset('watercolor-washes/ocean-wash', 'Ocean Wash', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#e0eef8"/><ellipse cx="22" cy="20" rx="20" ry="14" fill="#90c4e0" opacity="0.5"/><ellipse cx="30" cy="32" rx="16" ry="10" fill="#60a0c8" opacity="0.4"/></svg>'),
...
const marbleAndStone: AssetPack = {
  ...
  category: 'backgrounds',
  items: [
    asset('marble-and-stone/white-marble', 'White Marble', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#f4f2f0"/><path d="M0 12Q16 8 32 18T48 10" stroke="#d8d4d0" stroke-width="0.8" fill="none" opacity="0.6"/><path d="M0 28Q12 22 24 30T48 24" stroke="#c8c4c0" stroke-width="0.5" fill="none" opacity="0.5"/></svg>'),
    asset('marble-and-stone/black-marble', 'Black Marble', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#1a1a1a"/><path d="M0 16Q14 10 28 20T48 14" stroke="#444" stroke-width="0.8" fill="none" opacity="0.5"/><path d="M0 34Q18 28 36 36T48 30" stroke="#333" stroke-width="0.5" fill="none" opacity="0.4"/></svg>'),
    asset('marble-and-stone/rose-gold-marble', 'Rose Gold Marble', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#f8ece8"/><path d="M0 14Q14 8 30 18T48 12" stroke="#c8988c" stroke-width="0.8" fill="none" opacity="0.5"/><path d="M0 32Q16 26 32 34T48 28" stroke="#b8887c" stroke-width="0.5" fill="none" opacity="0.4"/></svg>'),
    asset('marble-and-stone/travertine', 'Travertine', 'png', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#e8e0d4"/><rect x="0" y="8" width="48" height="2" fill="#d0c8bc" opacity="0.4"/><rect x="0" y="20" width="48" height="3" fill="#c8c0b4" opacity="0.3"/><rect x="0" y="34" width="48" height="2" fill="#d0c8bc" opacity="0.35"/></svg>'),
...
const gradientMeshes: AssetPack = {
  ...
  category: 'backgrounds',
  items: [
    asset('gradient-meshes/aurora', 'Aurora (Blue-Purple)', 'pattern', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="au" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#4060c8"/><stop offset="50%" stop-color="#8040c0"/><stop offset="100%" stop-color="#6080e0"/></linearGradient></defs><rect width="48" height="48" fill="url(#au)"/></svg>'),
    asset('gradient-meshes/sunset', 'Sunset (Orange-Pink)', 'pattern', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="su" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#f08040"/><stop offset="50%" stop-color="#e06080"/><stop offset="100%" stop-color="#f0a060"/></linearGradient></defs><rect width="48" height="48" fill="url(#su)"/></svg>'),
    asset('gradient-meshes/ocean', 'Ocean (Teal-Blue)', 'pattern', 'backgrounds', '<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="oc" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#20a0a0"/><stop offset="50%" stop-color="#2080c0"/><stop offset="100%" stop-color="#40b0b0"/></linearGradient></defs><rect width="48" height="48" fill="url(#oc)"/></svg>'),
...
const cornerFlourishes: AssetPack = {
  ...
  category: 'accents',
  items: [
    asset('corner-flourishes/victorian-corner', 'Victorian Corner', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M4 44V8c0-2 2-4 4-4h36"/><path d="M4 36Q12 36 12 28Q12 20 20 20Q28 20 28 12Q28 8 32 4"/><circle cx="12" cy="28" r="2" fill="currentColor"/></svg>'),
    asset('corner-flourishes/art-nouveau-corner', 'Art Nouveau Corner', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M4 44V4h40"/><path d="M4 36Q10 30 8 20Q6 10 16 8Q26 6 28 14Q30 22 40 4" stroke-width="2"/></svg>'),
    asset('corner-flourishes/botanical-corner', 'Botanical Corner', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M4 44V4h40" fill="none" stroke="currentColor" stroke-width="1.5"/><ellipse cx="10" cy="12" rx="4" ry="6" transform="rotate(-20 10 12)"/><ellipse cx="18" cy="8" rx="4" ry="6" transform="rotate(-10 18 8)"/><ellipse cx="8" cy="22" rx="4" ry="6" transform="rotate(70 8 22)"/></svg>'),
    asset('corner-flourishes/geometric-corner', 'Geometric Corner', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M4 44V4h40"/><path d="M4 20h16V4"/><path d="M4 12h8V4"/><rect x="8" y="8" width="4" height="4" fill="currentColor"/></svg>'),
...
const sectionDividers: AssetPack = {
  ...
  category: 'accents',
  items: [
    asset('section-dividers/vine-divider', 'Vine Divider', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M4 24Q12 16 24 24Q36 32 44 24"/><ellipse cx="12" cy="20" rx="2" ry="3" fill="currentColor"/><ellipse cx="36" cy="28" rx="2" ry="3" fill="currentColor"/></svg>'),
    asset('section-dividers/geometric-line', 'Geometric Line', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><line x1="4" y1="24" x2="18" y2="24"/><rect x="20" y="20" width="8" height="8" transform="rotate(45 24 24)"/><line x1="30" y1="24" x2="44" y2="24"/></svg>'),
    asset('section-dividers/wave-swoosh', 'Wave Swoosh', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M4 28Q10 18 16 24Q22 30 28 24Q34 18 40 24Q44 28 44 24"/></svg>'),
    asset('section-dividers/floral-garland', 'Floral Garland', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M4 24Q24 12 44 24" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="14" cy="20" r="3"/><circle cx="24" cy="17" r="3"/><circle cx="34" cy="20" r="3"/></svg>'),
...
const monogramFrames: AssetPack = {
  ...
  category: 'accents',
  items: [
    asset('monogram-frames/circle-wreath', 'Circle Wreath', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="18" fill="none" stroke="currentColor" stroke-width="2"/><ellipse cx="10" cy="16" rx="3" ry="5" transform="rotate(-30 10 16)"/><ellipse cx="10" cy="32" rx="3" ry="5" transform="rotate(30 10 32)"/><ellipse cx="38" cy="16" rx="3" ry="5" transform="rotate(30 38 16)"/><ellipse cx="38" cy="32" rx="3" ry="5" transform="rotate(-30 38 32)"/><ellipse cx="24" cy="6" rx="5" ry="3"/><ellipse cx="24" cy="42" rx="5" ry="3"/></svg>'),
    asset('monogram-frames/oval-botanical', 'Oval Botanical', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><ellipse cx="24" cy="24" rx="14" ry="20" fill="none" stroke="currentColor" stroke-width="2"/><ellipse cx="12" cy="18" rx="3" ry="5" transform="rotate(-20 12 18)"/><ellipse cx="36" cy="18" rx="3" ry="5" transform="rotate(20 36 18)"/><ellipse cx="12" cy="30" rx="3" ry="5" transform="rotate(20 12 30)"/><ellipse cx="36" cy="30" rx="3" ry="5" transform="rotate(-20 36 30)"/></svg>'),
    asset('monogram-frames/diamond-geometric', 'Diamond Geometric', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><rect x="24" y="4" width="28" height="28" transform="rotate(45 24 24)"/><rect x="24" y="10" width="20" height="20" transform="rotate(45 24 24)" stroke-width="1"/></svg>'),
    asset('monogram-frames/shield-crest', 'Shield Crest', 'svg', 'accents', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M24 4L6 12v14c0 10 8 16 18 18 10-2 18-8 18-18V12L24 4z"/><path d="M24 10L12 16v10c0 7 5 11 12 13 7-2 12-6 12-13V16L24 10z" stroke-width="1"/></svg>'),
...
const romanticStickers: AssetPack = {
  ...
  category: 'stickers',
  items: [
    asset('romantic-stickers/heart-classic', 'Heart Classic', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M24 42L8 26a10 10 0 0 1 0-14.1 10 10 0 0 1 14.1 0L24 14l1.9-2.1a10 10 0 0 1 14.1 0 10 10 0 0 1 0 14.1L24 42z"/></svg>'),
    asset('romantic-stickers/heart-outline', 'Heart Outline', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2.5" xmlns="http://www.w3.org/2000/svg"><path d="M24 42L8 26a10 10 0 0 1 0-14.1 10 10 0 0 1 14.1 0L24 14l1.9-2.1a10 10 0 0 1 14.1 0 10 10 0 0 1 0 14.1L24 42z"/></svg>'),
    asset('romantic-stickers/heart-double', 'Heart Double', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M18 38L6 24a7 7 0 0 1 0-10 7 7 0 0 1 10 0l2 2 2-2a7 7 0 0 1 10 0 7 7 0 0 1 0 10L18 38z" opacity="0.5"/><path d="M30 34L20 22a6 6 0 0 1 0-8.5 6 6 0 0 1 8.5 0l1.5 1.5 1.5-1.5a6 6 0 0 1 8.5 0 6 6 0 0 1 0 8.5L30 34z"/></svg>'),
    asset('romantic-stickers/rings', 'Rings', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2.5" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="24" r="10"/><circle cx="30" cy="24" r="10"/></svg>'),
...
const celestialStickers: AssetPack = {
  ...
  category: 'stickers',
  items: [
    asset('celestial-stickers/moon-crescent', 'Moon Crescent', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M32 8A16 16 0 1 0 32 40 12 12 0 0 1 32 8z"/></svg>'),
    asset('celestial-stickers/moon-half', 'Moon Half', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M24 4a20 20 0 0 1 0 40V4z"/><circle cx="24" cy="24" r="20" fill="none" stroke="currentColor" stroke-width="2"/></svg>'),
    asset('celestial-stickers/moon-full', 'Moon Full', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="20"/><circle cx="18" cy="18" r="4" opacity="0.2" fill="white"/><circle cx="30" cy="28" r="3" opacity="0.15" fill="white"/></svg>'),
    asset('celestial-stickers/star-classic', 'Star Classic', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><polygon points="24,2 29,18 46,18 33,28 37,44 24,34 11,44 15,28 2,18 19,18"/></svg>'),
...
const botanicalStickers: AssetPack = {
  ...
  category: 'stickers',
  items: [
    asset('botanical-stickers/leaf-cluster', 'Leaf Cluster', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><ellipse cx="20" cy="20" rx="6" ry="10" transform="rotate(-30 20 20)"/><ellipse cx="30" cy="18" rx="6" ry="10" transform="rotate(20 30 18)"/><ellipse cx="24" cy="28" rx="6" ry="10" transform="rotate(5 24 28)"/></svg>'),
    asset('botanical-stickers/flower-bunch', 'Flower Bunch', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><circle cx="16" cy="16" r="6"/><circle cx="32" cy="16" r="6"/><circle cx="24" cy="12" r="6"/><path d="M18 24l-4 20h20l-4-20z" fill="none" stroke="currentColor" stroke-width="2"/></svg>'),
    asset('botanical-stickers/fern-frond', 'Fern Frond', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M24 4v40" stroke="currentColor" stroke-width="2" fill="none"/><path d="M24 10l-8 4M24 16l-10 5M24 22l-10 5M24 28l-8 4M24 10l8 4M24 16l10 5M24 22l10 5M24 28l8 4" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>'),
    asset('botanical-stickers/mushroom', 'Mushroom', 'svg', 'stickers', '<svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M6 24a18 18 0 0 1 36 0H6z"/><rect x="18" y="24" width="12" height="16" rx="2"/><circle cx="16" cy="16" r="3" fill="white" opacity="0.5"/><circle cx="28" cy="14" r="2" fill="white" opacity="0.5"/></svg>'),
