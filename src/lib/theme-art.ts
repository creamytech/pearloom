...
export const THEME_ART: Record<string, ThemeArt> = {
  ...
  'cottagecore': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M5 85 Q10 60 15 50 Q8 55 5 70 M10 80 Q18 55 25 42" fill="none" stroke="#A08060" stroke-width="1.5" opacity="0.25"/><circle cx="25" cy="40" r="2" fill="#A08060" opacity="0.15"/></svg>', dividerPath: 'M0,25 Q15,18 30,25 Q45,32 60,25 Q75,18 90,25 Q105,32 120,25 Q135,18 150,25 Q165,32 180,25 Q195,18 200,22' },
  'regency-romance': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M15 5 Q10 15 15 25 Q20 15 15 5Z M15 25 L10 35 L15 30 L20 35Z" fill="#9A7A40" opacity="0.2"/></svg>', dividerPath: 'M0,25 Q10,18 20,25 Q30,32 40,25 Q50,18 60,25 Q70,32 80,25 Q90,18 100,25 Q110,32 120,25 Q130,18 140,25 Q150,32 160,25 Q170,18 180,25 Q190,32 200,25' },
  'retro-disco': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="15" cy="15" r="8" fill="none" stroke="#C06830" stroke-width="1" opacity="0.2"/><circle cx="15" cy="15" r="12" fill="none" stroke="#C06830" stroke-width="0.5" opacity="0.1"/></svg>', dividerPath: 'M0,25 L20,25 L25,18 L30,25 L35,18 L40,25 L60,25 L80,25 L85,18 L90,25 L95,18 L100,25 L120,25 L140,25 L145,18 L150,25 L155,18 L160,25 L180,25 L200,25' },
  'black-and-white': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="5" y="5" width="15" height="15" fill="#111" opacity="0.08"/><rect x="20" y="5" width="15" height="15" fill="none" stroke="#111" stroke-width="0.5" opacity="0.06"/><rect x="5" y="20" width="15" height="15" fill="none" stroke="#111" stroke-width="0.5" opacity="0.06"/></svg>', dividerPath: 'M0,25 L200,25' },
  'gothic-cathedral': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10 40 L10 15 Q10 5 20 5 Q30 5 30 15 L30 40" fill="none" stroke="#8B1A2A" stroke-width="1.5" opacity="0.3"/><path d="M20 5 L20 40" stroke="#8B1A2A" stroke-width="0.5" opacity="0.15"/></svg>', dividerPath: 'M0,25 L15,25 L20,12 L25,25 L30,12 L35,25 L50,25 L65,25 L70,12 L75,25 L80,12 L85,25 L100,25 L115,25 L120,12 L125,25 L130,12 L135,25 L150,25 L165,25 L170,12 L175,25 L180,12 L185,25 L200,25' },
  'nautical-prep': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="20" cy="20" r="12" fill="none" stroke="#2A4A6A" stroke-width="1.5" opacity="0.2"/><path d="M20 8 L20 32 M8 20 L32 20" stroke="#2A4A6A" stroke-width="1" opacity="0.15"/></svg>', dividerPath: 'M0,25 Q25,15 50,25 Q75,35 100,25 Q125,15 150,25 Q175,35 200,25' },
  'mountain-lodge': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M5 40 L20 10 L35 40" fill="none" stroke="#4A6A38" stroke-width="1.5" opacity="0.2"/><path d="M15 40 L25 20 L35 40" fill="none" stroke="#4A6A38" stroke-width="1" opacity="0.12"/></svg>', dividerPath: 'M0,30 L10,15 L25,28 L40,10 L55,25 L70,12 L85,28 L100,8 L115,25 L130,15 L145,28 L160,10 L175,25 L190,15 L200,22' },
  'japandi-zen': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="20" cy="20" r="15" fill="none" stroke="#8A7A5A" stroke-width="0.8" opacity="0.15"/><path d="M20 5 L20 35" stroke="#8A7A5A" stroke-width="0.5" opacity="0.1"/></svg>', dividerPath: 'M0,25 L200,25' },
  'victorian-garden': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M5 5 L40 5 Q45 5 45 10 L45 40 Q45 45 40 45 L5 45" fill="none" stroke="#8B2020" stroke-width="1" opacity="0.15"/><path d="M10 10 L35 10 L35 35 L10 35Z" fill="none" stroke="#8B2020" stroke-width="0.5" opacity="0.1"/></svg>', dividerPath: 'M0,25 Q10,18 20,25 Q25,22 30,25 Q40,30 50,25 Q60,20 70,25 Q75,22 80,25 Q90,30 100,25 Q110,20 120,25 Q125,22 130,25 Q140,30 150,25 Q160,20 170,25 Q175,22 180,25 Q190,30 200,25' },
  'fall-harvest': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10 35 Q15 20 25 15 Q18 25 15 33 M5 40 Q12 22 28 12" fill="none" stroke="#B85C30" stroke-width="1.5" opacity="0.25"/><circle cx="25" cy="13" r="2" fill="#B85C30" opacity="0.15"/></svg>', dividerPath: 'M0,25 Q15,18 30,25 Q45,32 60,25 Q75,18 90,25 Q105,32 120,25 Q135,18 150,25 Q165,32 180,25 Q195,18 200,22' },
  'dark-academia': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="5" y="5" width="20" height="30" fill="none" stroke="#8A6030" stroke-width="1" opacity="0.2" rx="1"/><rect x="8" y="8" width="14" height="24" fill="none" stroke="#8A6030" stroke-width="0.5" opacity="0.12" rx="1"/><line x1="10" y1="15" x2="20" y2="15" stroke="#8A6030" stroke-width="0.5" opacity="0.1"/></svg>', dividerPath: 'M0,25 L200,25' },
  'old-money': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><line x1="5" y1="5" x2="30" y2="5" stroke="#2A4A6A" stroke-width="1" opacity="0.15"/><line x1="5" y1="5" x2="5" y2="30" stroke="#2A4A6A" stroke-width="1" opacity="0.15"/></svg>', dividerPath: 'M0,25 L200,25' },
  'maximalist-color': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="8" fill="#E03060" opacity="0.12"/><circle cx="25" cy="8" r="5" fill="#4040FF" opacity="0.08"/><circle cx="8" cy="25" r="6" fill="#FFB800" opacity="0.1"/></svg>', dividerPath: 'M0,20 Q10,30 20,20 Q30,10 40,20 Q50,30 60,20 Q70,10 80,20 Q90,30 100,20 Q110,10 120,20 Q130,30 140,20 Q150,10 160,20 Q170,30 180,20 Q190,10 200,20' },
  'country-barn': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M5 40 L5 15 L20 5 L35 15 L35 40" fill="none" stroke="#6A8A4A" stroke-width="1" opacity="0.2"/><line x1="20" y1="5" x2="20" y2="40" stroke="#6A8A4A" stroke-width="0.5" opacity="0.1"/></svg>', dividerPath: 'M0,25 Q15,20 30,25 Q45,30 60,25 Q75,20 90,25 Q105,30 120,25 Q135,20 150,25 Q165,30 180,25 Q195,20 200,25' },
  'western-ranch': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10 35 L10 10 L15 5 L20 10 L20 35 M5 15 L25 15" fill="none" stroke="#8A5A30" stroke-width="1.5" opacity="0.2"/></svg>', dividerPath: 'M0,25 L10,25 L15,20 L20,25 L25,20 L30,25 L40,25 L50,25 L60,25 L65,20 L70,25 L75,20 L80,25 L90,25 L100,25 L110,25 L115,20 L120,25 L125,20 L130,25 L140,25 L150,25 L200,25' },
  'romantic-blush': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M15 28 Q10 15 18 8 Q26 15 20 25Z" fill="#D48A8A" opacity="0.15"/><path d="M8 35 Q12 20 22 12" fill="none" stroke="#D48A8A" stroke-width="1" opacity="0.15"/></svg>', dividerPath: 'M0,25 Q25,15 50,25 Q75,35 100,25 Q125,15 150,25 Q175,35 200,25' },
  'wildflower-meadow': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="3" fill="#E07040" opacity="0.2"/><circle cx="22" cy="8" r="2" fill="#E0A060" opacity="0.15"/><circle cx="8" cy="22" r="2.5" fill="#E07040" opacity="0.12"/><path d="M5 30 Q8 20 15 15" fill="none" stroke="#E07040" stroke-width="1" opacity="0.15"/></svg>', dividerPath: 'M0,22 Q10,28 20,22 Q30,18 40,25 Q50,30 60,22 Q70,18 80,25 Q90,30 100,22 Q110,18 120,25 Q130,30 140,22 Q150,18 160,25 Q170,30 180,22 Q190,18 200,25' },
  'whimsical-garden': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="15" cy="15" r="10" fill="none" stroke="#D46090" stroke-width="1" opacity="0.15" stroke-dasharray="3 3"/><circle cx="15" cy="15" r="3" fill="#D46090" opacity="0.1"/></svg>', dividerPath: 'M0,20 Q12,30 25,20 Q37,10 50,20 Q62,30 75,20 Q87,10 100,20 Q112,30 125,20 Q137,10 150,20 Q162,30 175,20 Q187,10 200,20' },
  'nature-organic': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M5 40 Q8 25 18 15 Q10 28 8 38 M10 35 Q15 20 28 10" fill="none" stroke="#4A7A3A" stroke-width="1.5" opacity="0.25"/><circle cx="28" cy="8" r="2" fill="#4A7A3A" opacity="0.15"/></svg>', dividerPath: 'M0,28 Q15,18 30,25 Q45,32 60,22 Q75,18 90,28 Q105,32 120,22 Q135,18 150,28 Q165,32 180,22 Q195,18 200,25' },
  'y2k-reloaded': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="15" cy="15" r="10" fill="#FF69B4" opacity="0.1"/><circle cx="28" cy="10" r="6" fill="#40C4FF" opacity="0.08"/><circle cx="10" cy="28" r="7" fill="#FF69B4" opacity="0.06"/></svg>', dividerPath: 'M0,25 L200,25' },
  'aged-to-perfection': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10 35 Q10 10 35 10" fill="none" stroke="#722F37" stroke-width="1.5" opacity="0.2"/><circle cx="10" cy="10" r="2" fill="#722F37" opacity="0.15"/></svg>', dividerPath: 'M0,25 Q50,18 100,25 Q150,32 200,25' },
  'future-noir': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><line x1="5" y1="5" x2="35" y2="5" stroke="#00D4FF" stroke-width="1" opacity="0.3"/><line x1="5" y1="5" x2="5" y2="35" stroke="#00D4FF" stroke-width="1" opacity="0.3"/><line x1="5" y1="15" x2="25" y2="15" stroke="#00D4FF" stroke-width="0.5" opacity="0.15"/></svg>', dividerPath: 'M0,25 L200,25' },
  'martini-hour': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10 5 L25 25 L15 25Z" fill="none" stroke="#D4A800" stroke-width="1" opacity="0.2"/><line x1="20" y1="25" x2="20" y2="40" stroke="#D4A800" stroke-width="1" opacity="0.15"/><line x1="14" y1="40" x2="26" y2="40" stroke="#D4A800" stroke-width="1" opacity="0.15"/></svg>', dividerPath: 'M0,25 Q50,18 100,25 Q150,32 200,25' },
  'gothic-masquerade': { cornerSvg: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10 20 Q15 10 25 12 Q20 18 25 25 Q15 22 10 20Z" fill="none" stroke="#8B0000" stroke-width="1" opacity="0.25"/><circle cx="18" cy="18" r="3" fill="#8B0000" opacity="0.1"/></svg>', dividerPath: 'M0,25 Q25,12 50,25 Q75,38 100,25 Q125,12 150,25 Q175,38 200,25' },
