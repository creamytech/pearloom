...
export const SITE_TEMPLATES: SiteTemplate[] = [
...

  {
    ...
    blocks: [
      ...
      makeBlock('photos', 10), makeBlock('faq', 11), makeBlock('guestbook', 12, { title: 'The Guest Ledger' }), makeBlock('footer', 13, { text: '{{ poetry.closingLine }}', subtitle: 'Made with Pearloom' }),
    ],
