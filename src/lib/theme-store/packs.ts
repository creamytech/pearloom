...
export const PACKS: readonly Pack[] = [
  ...
  mk({ id: 'coastal-ink', name: 'Coastal Ink', collection: 'coastal', blurb: 'Harbor navy on bone paper — pared-back stationery for the seaside formal.', paper: '#EAE5D7', ink: '#15212C', accent: '#1F3A4D', gold: '#B89968', motif: 'none', kit: 'minimal', texture: 'cotton', display: F.fraunces, wght: '500', ls: '0.2em', price: 16, tags: ['coastal', 'navy', 'minimal', 'harbor', 'formal'] }),
  ...
  mk({ id: 'retro-marquee', name: 'Retro Marquee', collection: 'prints', blurb: 'Diner-red diagonals on canvas — neon marquee energy, lowered into print.', paper: '#F8EFDE', ink: '#1A0E0E', accent: '#C73A3A', gold: '#D8A24E', accent2: '#5A2A2A', texture: 'canvas', pattern: 'diagonal', motif: 'none', kit: 'ticket', display: F.playfair, body: F.dmsans, wght: '600', tags: ['retro', 'marquee', 'diner', 'red', 'diagonal', 'midcentury'], price: 16 }),
