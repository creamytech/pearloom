...
// (collection, price, tier, badges, tags) and the
...
export interface PackBadges {
  /* `best` is gone (T.5) — a "★ Bestseller" ribbon with an empty
     sales ledger was fabricated social proof. `new` is an honest
     editorial fact (recently added to the catalog). */
  new?: boolean;
}
