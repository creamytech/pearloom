...
export const PACKS: readonly Pack[] = [
  ...
  mk({ id: 'shell-blush', name: 'Shell Blush', collection: 'coastal', blurb: 'Seafoam wash on sand paper with scallop-shell motifs — arches like tidepools.', paper: '#F2EDDF', ink: '#1F3833', accent: '#6FA8A0', gold: '#C7A971', motif: 'bow', kit: 'scallop', texture: 'cotton', display: F.fraunces, wght: '500', radius: 16, monogramFrame: 'bow-crest', price: 0, tags: ['coastal', 'shell', 'seafoam', 'scallop', 'beach'] }),
