// ─────────────────────────────────────────────────────────────
// demo-manifest — the canonical showcase site (Alex & Jamie's
// garden wedding). Served in PRODUCTION at /demo so the marketing
// page's "Read a real site" CTAs open something real, and reused
// by /dev/site (which adds query-param look knobs for visual QA).
// ─────────────────────────────────────────────────────────────

import type { StoryManifest } from '@/types';

export const DEMO_NAMES: [string, string] = ['Alex', 'Jamie'];
