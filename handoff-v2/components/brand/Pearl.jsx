 ...
 */
export function Pearl({ size = 10, iridescent = false, style }) {
  if (iridescent) {
    return (
      <span
        style={{
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 12 12" aria-hidden="true" style={{ flexShrink: 0, display: 'inline-block', verticalAlign: 'middle', ...style }}>
      <circle cx="6" cy="6" r="4.4" fill="var(--pl-gold)" stroke="var(--pl-cream)" strokeWidth="1.4"></circle>
    </svg>
  );
}
